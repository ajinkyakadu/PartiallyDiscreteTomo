...
for n=1:nargin
   ...
   elseif(isa(varargin{n},'RandStream'))
      ...
      error('comm:awgn:InvalidArg','Only string, numeric, or RandStream arguments are allowed.');
   end
end
...
y = sig+wgn1(size(sig,1), size(sig,2), noisePower, 1, state, pMode, opType);